...
.done:
    ...
    sqrtsd xmm0, xmm0           ; xmm0 = sqrt(a² + b²)
    
    ; Normalize by size (not standard, but useful for quantum entanglement)
    cvtsi2sd xmm1, r14         ; Convert size to double
    divsd xmm0, xmm1           ; xmm0 = entanglement / size
...
section .data
    align 8
    decoherence_factor: dq 0.1        ; 0.1 constant for decoherence
    two_pi: dq 6.28318530717959       ; 2π
    rand_divisor: dq 18446744073709551615.0  ; 2^64-1 for normalization
    sign_bit: dq 0x8000000000000000, 0x0000000000000000  ; For negating doubles
